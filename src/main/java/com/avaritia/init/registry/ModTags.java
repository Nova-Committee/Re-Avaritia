...
public class ModTags {
    ...
    public static final TagKey<Block> EXTREME_ANVIL_UNBREAK = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "extreme_anvil_unbreak"));
    public static final TagKey<Block> NEEDS_CRYSTAL_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "needs_crystal_tool"));
    public static final TagKey<Block> NEEDS_BLAZE_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "needs_blaze_tool"));
    public static final TagKey<Block> NEEDS_INFINITY_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "needs_infinity_tool"));
