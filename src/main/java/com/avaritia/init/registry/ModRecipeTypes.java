...
public class ModRecipeTypes {
    public static final DeferredRegister<RecipeType<?>> RECIPES = DeferredRegister.create(Registries.RECIPE_TYPE, Avaritia.MOD_ID);

    public static final DeferredHolder<RecipeType<?>, RecipeType<ITierCraftingRecipe>> CRAFTING_TABLE_RECIPE =
            recipe("crafting_table_recipe", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "crafting_table_recipe")));
    public static final DeferredHolder<RecipeType<?>, RecipeType<ICompressorRecipe>> COMPRESSOR_RECIPE =
            recipe("compressor_recipe", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "compressor_recipe")));
    public static final DeferredHolder<RecipeType<?>, RecipeType<ExtremeSmithingRecipe>> EXTREME_SMITHING_RECIPE =
            recipe("extreme_smithing_recipe", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(Avaritia.MOD_ID, "extreme_smithing_recipe")));
