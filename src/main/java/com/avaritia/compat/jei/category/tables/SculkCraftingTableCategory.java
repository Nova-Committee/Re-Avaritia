...
public class SculkCraftingTableCategory implements IRecipeCategory<RecipeHolder<ITierCraftingRecipe>> {
    public static final IRecipeHolderType<ITierCraftingRecipe> RECIPE_TYPE = IRecipeHolderType.create(Identifier.of(Avaritia.MOD_ID, "sculk_craft"));
    private static final Identifier TEXTURE = Identifier.of(Avaritia.MOD_ID, "textures/gui/jei/tables/sculk_jei.png");
    ...
    public @NotNull Component getTitle() {
        return Component.translatable("jei.category.avaritia.sculk_crafting_table");
    }
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, RecipeHolder<ITierCraftingRecipe> recipeHolder, @NotNull IFocusGroup focuses) {
        ...
        if (recipe instanceof ShapedTableCraftingRecipe shaped) {
            ...
            builder.addSlot(RecipeIngredientRole.OUTPUT, 96, 20).add(output);
            ...
            shapelessRecipe(builder, inputs);
            builder.addSlot(RecipeIngredientRole.OUTPUT, 96, 20).add(new ItemStack(ModItems.infinity_catalyst.get()));
        } else if (recipe instanceof EternalSingularityCraftRecipe) {
            shapelessRecipe(builder, inputs);
            builder.addSlot(RecipeIngredientRole.OUTPUT, 96, 20).add(new ItemStack(ModItems.eternal_singularity.get()));
        }
