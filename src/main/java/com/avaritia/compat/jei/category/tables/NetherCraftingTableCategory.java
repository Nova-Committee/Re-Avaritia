...
public class NetherCraftingTableCategory implements IRecipeCategory<RecipeHolder<ITierCraftingRecipe>> {
    public static final IRecipeHolderType<ITierCraftingRecipe> RECIPE_TYPE = IRecipeHolderType.create(Identifier.of(Const.MOD_ID, "nether_craft"));
    private static final Identifier TEXTURE = Identifier.of(Const.MOD_ID, "textures/gui/jei/tables/nether_jei.png");
