...
public class EndCraftingTableCategory implements IRecipeCategory<RecipeHolder<ITierCraftingRecipe>> {
    public static final IRecipeHolderType<ITierCraftingRecipe> RECIPE_TYPE = IRecipeHolderType.create(Identifier.fromNamespaceAndPath(Const.MOD_ID, "end_craft"));
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Const.MOD_ID, "textures/gui/jei/tables/end_jei.png");
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, RecipeHolder<ITierCraftingRecipe> recipeHolder, @NotNull IFocusGroup focuses) {
        ...
        if (recipe instanceof ShapedTableCraftingRecipe shaped) {
            TableRecipeLayouts.addShapedInputs(builder, shaped, 7, 5, 5);
    ...
    private void shapelessRecipe(@NotNull IRecipeLayoutBuilder builder, NonNullList<Ingredient> inputs) {
        TableRecipeLayouts.addShapelessInputs(builder, inputs, 7, 2, 2);
