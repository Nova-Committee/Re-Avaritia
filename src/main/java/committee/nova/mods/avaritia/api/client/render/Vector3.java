...
import committee.nova.mods.avaritia.util.math.Copyable;
...
/**
 * Name: Avaritia-forge / Vector3
 * Author: cnlimiter
 * CreateTime: 2023/9/24 22:56
 * Description:
 */
...
public class Vector3 implements Copyable<Vector3> {
    ...
    public static Vector3 fromEntityCenter(Entity e) {
        return new Vector3(e.position()).add(0, e.getMyRidingOffset(e) + e.getBbHeight() / 2, 0);
    }
