...
/**
 * Name: Avaritia-forge / Quad
 * Author: cnlimiter
 * CreateTime: 2023/9/24 22:53
 * Description:
 */

public class Quad implements IVertexConsumer{
    ...
    public BakedQuad bake() {
        ...
        for (int v = 0; v < 4; v++) {
            for (int e = 0; e < format.elementCount; e++) {
                VertexUtil.pack(vertices[v].raw[e], packedData, format.format, v, e);
            }
        }
