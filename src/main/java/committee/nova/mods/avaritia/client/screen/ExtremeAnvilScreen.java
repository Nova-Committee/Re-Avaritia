...
public class ExtremeAnvilScreen extends BaseContainerScreen<ExtremeAnvilMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.blit(EXTREME_ANVIL_TEX, this.nameBackground.left(), this.nameBackground.top(), 0, this.imageHeight + (this.menu.getSlot(0).hasItem() ? 0 : 16), this.nameBackground.width(), this.nameBackground.height());
    }
    ...
    protected void renderBgs(@NotNull GuiGraphics pGuiGraphics, float pPartialTick, int pX, int pY) {
        if ((this.menu.getSlot(0).hasItem() || this.menu.getSlot(1).hasItem()) && !this.menu.getSlot(this.menu.getResultSlot()).hasItem()) {
            pGuiGraphics.blit(EXTREME_ANVIL_TEX, this.errorIcon.left(), this.errorIcon.top(), this.imageWidth, 0, this.errorIcon.width(), this.errorIcon.height());
