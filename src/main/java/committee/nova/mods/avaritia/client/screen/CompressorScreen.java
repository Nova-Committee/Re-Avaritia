...
//        }
    ...
    protected void renderLabels(@NotNull PoseStack stack, int mouseX, int mouseY) {
        ...
        drawString(stack, font, title, (this.imageWidth / 2 - this.font.width(title) / 2), 6, 4210752);
        drawString(stack, font, this.playerInventoryTitle, 8, this.imageHeight - 94, 4210752);
    }
