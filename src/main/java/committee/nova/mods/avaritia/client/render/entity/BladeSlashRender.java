...
public class BladeSlashRender extends EntityRenderer<BladeSlashEntity> {
    ...
    public void vertex(Matrix4f pose, Matrix3f normal, VertexConsumer builder, float x, float y, float z,
                       float u, float v, int nx, int nz, int ny, int packedLight, int alpha) {
