    ...
    public void render(LivingEntity livingEntity, PoseStack poseStack, MultiBufferSource multiBufferSource, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        if (livingEntity instanceof Player player) {
            if (chestItem == ModItems.infinity_chestplate.get() && (player.getAbilities().flying)) {
                ...
                leftWing.render(poseStack, Res.ARMOR_WING_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
                rightWing.render(poseStack, Res.ARMOR_WING_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());

                leftWing.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.WING_GLOW_TEX)), packedLight, packedOverlay, new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
                rightWing.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.WING_GLOW_TEX)), packedLight, packedOverlay,  new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
                poseStack.popPose();
            }
        }
        ...
        if (headItem == ModItems.infinity_helmet.get()) {
            ...
            ModelPart head = this.bodyRoot.getChild("head");
            head.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            ModelPart hat = this.bodyRoot.getChild("hat");
            hat.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
        ...
        if (chestItem == ModItems.infinity_chestplate.get()) {
            ...
            ModelPart body = this.bodyRoot.getChild("body");
            body.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            body.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.EYE_TEX)), packedLight, packedOverlay,  new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
            ModelPart leftArm = this.bodyRoot.getChild("left_arm");
            leftArm.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            leftArm.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.EYE_TEX)), packedLight, packedOverlay,  new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
            ModelPart rightArm = this.bodyRoot.getChild("right_arm");
            rightArm.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            rightArm.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.EYE_TEX)), packedLight, packedOverlay,  new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
        ...
        if (legsItem == ModItems.infinity_pants.get()) {
            ...
            ModelPart leftLeg = this.bodyRoot.getChild("left_leg");
            leftLeg.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            leftLeg.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.EYE_TEX)), packedLight, packedOverlay, new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
            ModelPart rightLeg = this.bodyRoot.getChild("right_leg");
            rightLeg.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            rightLeg.render(poseStack, multiBufferSource.getBuffer(AvaritiaRenderTypes.WingGlow(Res.EYE_TEX)), packedLight, packedOverlay, new ColorRGBA(0.84F, 1.0F, 0.95F, (float) (pulse_mag_sqr * 0.5D)).pack());
        ...
        if (feetItem == ModItems.infinity_boots.get()) {
            ...
            ModelPart leftBoot = this.bodyRoot.getChild("left_boot");
            leftBoot.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
            ModelPart rightBoot = this.bodyRoot.getChild("right_boot");
            rightBoot.render(poseStack, Res.ARMOR_MASK.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
        ...
        if (headItem == ModItems.infinity_helmet.get() && chestItem == ModItems.infinity_chestplate.get() && legsItem == ModItems.infinity_pants.get() && feetItem == ModItems.infinity_boots.get()) {
            ...
            super.renderToBuffer(poseStack, Res.ARMOR_MASK_INV.wrap(multiBufferSource.getBuffer(COSMIC_ARMOR_RENDER_TYPE)), packedLight, packedOverlay, new ColorRGBA(red, green, blue, alpha).pack());
