...
public class RecipeGeneratorScreen extends BaseContainerScreen<RecipeGeneratorMenu> {
    ...
    protected void subInit() {
        ...
        this.addRenderableWidget(
                GuiUtils
                        .newButton(centerX + 40, centerY + 180, 20, 10,
        ...
        // 添加等级选择按钮 (使用CycleButton)
        this.addRenderableWidget(
                CycleButton.builder((String value) -> Component.literal("等级" + value))
                        .withValues("1", "2", "3", "4")
                        .withInitialValue(String.valueOf(this.tier + 1))
                        .create(centerX + 60, centerY + 180, 20, 10,
        ...
        // 添加选择模式切换按钮
        this.addRenderableWidget(
                GuiUtils.newButton(centerX + 80, centerY + 180, 20, 10,
        ...
        this.addRenderableWidget(
                GuiUtils
                        .newButton(centerX + 100, centerY + 180, 20, 10,
