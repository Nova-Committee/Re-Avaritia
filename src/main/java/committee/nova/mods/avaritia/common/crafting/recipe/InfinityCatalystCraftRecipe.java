...
import committee.nova.mods.avaritia.api.common.crafting.RecipeCodecs;
...
public class InfinityCatalystCraftRecipe extends ShapelessTableCraftingRecipe {
     ...
     */
    private boolean matchesSingularityRecipe(@NotNull TierInput input) {
        // 获取配料列表（会加载所有奇点）
     ...
     * 处理非默认组的标准无形合成匹配逻辑
     */
    private boolean matchesStandardRecipe(@NotNull TierInput input) {
