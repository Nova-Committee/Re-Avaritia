package committee.nova.mods.avaritia.common.tile.config;
...
public class SideConfiguration {
    ...
    public enum SideMode {
        ...
        public boolean canInput() {
            return this == PASSIVE_INPUT || this == ACTIVE_INPUT;
        }

        public boolean canOutput() {
            return this == PASSIVE_OUTPUT || this == ACTIVE_OUTPUT;
        }

        public boolean isActive() {
            return this == ACTIVE_INPUT || this == ACTIVE_OUTPUT;
        }

        public boolean isPassive() {
            return this == PASSIVE_INPUT || this == PASSIVE_OUTPUT;
        }
