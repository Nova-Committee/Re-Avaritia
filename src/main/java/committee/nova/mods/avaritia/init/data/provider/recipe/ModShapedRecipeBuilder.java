...
public class ModShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public ModShapedRecipeBuilder define(Character p_126128_, ItemStack p_126129_) {
        return this.define(p_126128_, DefaultCustomIngredients.nbt(p_126129_, true));
    }
    ...
    public void save(@NotNull Consumer<FinishedRecipe> p_126141_, @NotNull ResourceLocation p_126142_) {
        ...
        p_126141_.accept(new Result(p_126142_, this.result, this.count, this.group == null ? "" : this.group,
    ...
    public static class Result extends CraftingResult {
        ...
        public void serializeRecipeData(@NotNull JsonObject p_126167_) {
            ...
            jsonobject1.addProperty("item", Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(this.result)).toString());
            if (this.count > 1) {
