...
public class ModItems {
    ...
    //blaze
    public static RegistryObject<Item> blaze_skull_sword = item("blaze_skull_sword", BlazeSkullSwordItem::new);
    public static RegistryObject<Item> blaze_soul_hoe = item("blaze_soul_hoe", BlazeSoulHoeItem::new);
    public static RegistryObject<Item> blaze_lava_pickaxe = item("blaze_lava_pickaxe", BlazeLavaPickaxeItem::new);
    public static RegistryObject<Item> blaze_fire_shovel = item("blaze_fire_shovel", BlazeFireShovelItem::new);
    public static RegistryObject<Item> blaze_bush_axe = item("blaze_bush_axe", BlazeBushAxeItem::new);
     ...
     */
    //fire
    public static RegistryObject<Item> blaze_cube = item("blaze_cube",  () -> new ResourceItem(ModRarities.UNCOMMON, "blaze_cube", true));
    //wind
