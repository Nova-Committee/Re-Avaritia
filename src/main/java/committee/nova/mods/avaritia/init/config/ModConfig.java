...
public class ModConfig {
    ...
    static {
        ...
        immortalItemEntitySpeed = buildDouble(common, "Endless ItemEntity Speed", 3, 1, 50, "The speed of Endless ItemEntity");
        infinityElytraFlyingSpeed = buildDouble(common, "Infinity Elytra Flying Speed", 1.5, 0, 100, "Infinity Elytra Flying Speed");
