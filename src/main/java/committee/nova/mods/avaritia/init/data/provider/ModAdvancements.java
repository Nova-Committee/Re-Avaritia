...
public class ModAdvancements extends FabricAdvancementProvider {
    ...
    @Override
    public void generateAdvancement(@NotNull Consumer<Advancement> consumer) {
        ...
        this.subProvider.forEach(provider -> provider.generate(root, consumer));
    }

    private interface ModAdvancementSubProvider {
        void generate(@NotNull Advancement root, @NotNull Consumer<Advancement> consumer);
    }
    ...
    private static class MainAdvancements implements ModAdvancementSubProvider {
        ...
        @Override
        public void generate(@NotNull Advancement root, @NotNull Consumer<Advancement> consumer) {
            ...
            this.subProvider.forEach(provider -> provider.generate(singularity, consumer));
    ...
    private static class SingularityAdvancements implements ModAdvancementSubProvider {
        ...
        public void generate(@NotNull Advancement root, @NotNull Consumer<Advancement> consumer) {
            ...
            this.subProvider.forEach(provider -> provider.generate(infinity_catalyst, consumer));
        }
    }
