    ...
    private static String extraJson(String locale) {
        return switch (locale) {
            case "en_us" -> """
            {
              ...
              "message.avaritia.crystal_spear.exhausted": "Seven In, Seven Out is exhausted. Switch modes to reset.",
            ...
            case "ja_jp" -> """
            {
              ...
              "message.avaritia.crystal_spear.exhausted": "七進七退を使い切りました。モード切替で回復します。",
            ...
            case "zh_cn" -> """
            {
              ...
              "message.avaritia.crystal_spear.exhausted": "七进七出次数已耗尽，切换模式后可重置",
            ...
            case "zh_tw" -> """
            {
              ...
              "message.avaritia.crystal_spear.exhausted": "七進七出次數已耗盡，切換模式後可重置",
              "tooltip.avaritia.tool.blaze_spear_blast": "炎爆",
            ...
            case "uk_ua" -> """
            {
              ...
              "message.avaritia.crystal_spear.exhausted": "Сім входів, сім виходів вичерпано. Змініть режим для відновлення.",
