...
public class NoConsumeCatalystShapedRecipeBuilder implements RecipeBuilder {
    ...
    public NoConsumeCatalystShapedRecipeBuilder(RecipeCategory category, ItemLike itemLike, ResourceLocation itemLocation, int count, int tier) {
    ...
    @Contract("_, _, _ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ResourceLocation itemLocation, int tier) {
        return shaped(category, null, itemLocation, 1, tier);
    }

    @Contract("_, _ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ResourceLocation itemLocation) {
        return shaped(category, null, itemLocation, 1, 4);
    }


    @Contract("_, _, _ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ItemLike itemLike, int tier) {
        return shaped(category, itemLike, null, 1, tier);
    }

    @Contract("_, _ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ItemLike itemLike) {
        return shaped(category, itemLike, null, 1, 4);
    }

    @Contract("_, _, _, _, _ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ItemLike itemLike, ResourceLocation itemLocation, int count, int tier) {
        return new NoConsumeCatalystShapedRecipeBuilder(category, itemLike, itemLocation, count, tier);
    }

    @Contract("_,_,_,_ -> new")
    public static @NotNull NoConsumeCatalystShapedRecipeBuilder shaped(RecipeCategory category, ItemLike itemLike, int count, int tier) {
        return shaped(category, itemLike, null, count, tier);
    }


    public NoConsumeCatalystShapedRecipeBuilder define(Character character, TagKey<Item> tagKey) {
        return this.define(character, Ingredient.of(tagKey));
    }

    public NoConsumeCatalystShapedRecipeBuilder define(Character character, ItemLike itemLike) {
        return this.define(character, Ingredient.of(itemLike));
    }

    public NoConsumeCatalystShapedRecipeBuilder define(Character character, Mods mod, String stack) {
        return this.define(character, new SimpleDatagenIngredient(mod,  stack).toVanilla());
    }

    public NoConsumeCatalystShapedRecipeBuilder define(Character character, Ingredient ingredient) {
    ...
    public NoConsumeCatalystShapedRecipeBuilder pattern(String s) {
    ...
    @Override
    public @NotNull NoConsumeCatalystShapedRecipeBuilder group(@Nullable String pGroupName) {
