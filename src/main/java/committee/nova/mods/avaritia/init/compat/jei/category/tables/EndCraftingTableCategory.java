...
public class EndCraftingTableCategory implements IRecipeCategory<BaseTableCraftingRecipe> {
    ...
    public static final RecipeType<BaseTableCraftingRecipe> RECIPE_TYPE = RecipeType.create(Const.MOD_ID, "end_craft", BaseTableCraftingRecipe.class);
    private static final ResourceLocation TEXTURE = Const.rl( "textures/gui/jei/tables/end_jei.png");
