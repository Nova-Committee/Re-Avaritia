...
public class JeiCompat implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        registration.addRecipeCategories(new ExtremeTableCategory(helper));
    }
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration) {
        ...
        if (world != null) {
            ...
            registration.addRecipes(ExtremeTableCategory.RECIPE_TYPE, manager.getAllRecipesFor(ModRecipeTypes.EXTREME_CRAFT_RECIPE.get()));
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.extreme_crafting_table.get()), ExtremeTableCategory.RECIPE_TYPE);

    }

    @Override
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(ExtremeCraftingMenu.class, ModMenus.extreme_crafting_table.get(), ExtremeTableCategory.RECIPE_TYPE, 1, 81, 82, 36);
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        ...
        registration.addRecipeClickArea(ExtremeCraftingScreen.class, 174, 90, 21, 14, ExtremeTableCategory.RECIPE_TYPE);
