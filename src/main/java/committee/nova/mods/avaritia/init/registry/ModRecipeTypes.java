...
public class ModRecipeTypes {
    ...
    public static final @NotNull RegistryObject<RecipeType<Recipe<Container>>> EXTREME_CRAFT_RECIPE = recipe("extreme_craft_recipe", () -> RecipeType.simple(new ResourceLocation(Static.MOD_ID, "extreme_craft_recipe")));
    public static final @NotNull RegistryObject<RecipeType<Recipe<Container>>> INFINITY_CATALYST_RECIPE = recipe("infinity_catalyst_recipe", () -> RecipeType.simple(new ResourceLocation(Static.MOD_ID, "infinity_catalyst_recipe")));
