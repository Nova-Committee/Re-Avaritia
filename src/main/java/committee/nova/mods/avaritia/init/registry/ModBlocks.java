...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> tesseract = itemBlock("tesseract", TesseractBlock::new,
            new Item.Properties().fireResistant().rarity(ModRarities.COSMIC.getValue()));
