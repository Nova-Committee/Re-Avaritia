...
import committee.nova.mods.avaritia.util.registry.BaseBlockItem;
...
public class ModBlocks {
    ...
    public static RegistryObject<Block> neutronium = block("neutronium", () -> new ResourceBlock(MapColor.METAL, SoundType.METAL));
    public static RegistryObject<Block> infinity = block("infinity", () -> new ResourceBlock(MapColor.METAL, SoundType.METAL));
    public static RegistryObject<Block> crystal_matrix = block("crystal_matrix", () -> new ResourceBlock(MapColor.METAL, SoundType.METAL));
