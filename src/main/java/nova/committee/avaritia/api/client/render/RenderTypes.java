...
import nova.committee.avaritia.init.handler.ShaderHandler;

public class RenderTypes extends RenderStateShard {

    public static final RenderStateShard.ShaderStateShard COSMIC_SHADER = new RenderStateShard.ShaderStateShard(() -> ShaderHandler.cosmicShader);
